...
interface Props {
  onAdd: (payload: { title: string; type: 'good' | 'bad'; difficulty: number }) => void
  onCancel: () => void
  isLoading: boolean
  defaultType?: 'good' | 'bad'
}

export default function HabitForm({ onAdd, onCancel, isLoading, defaultType = 'good' }: Props) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    onAdd({ title: title.trim(), type, difficulty })
  }
