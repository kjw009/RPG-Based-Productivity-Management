...
-- ============================================================
-- SEED FUNCTION — called from the app on first login
-- Creates default player, abilities, and shop items
-- ============================================================
...
AS $$
BEGIN
  -- Only seed if player row doesn't exist yet
...
-- ============================================================
-- MANA RESET — runs every Monday via pg_cron
